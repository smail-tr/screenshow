      ...
      <div  id="wrapper">
       ...
       <li style="width: 300px;font-size: 20px;" class="nav-item"> 
        ...
        <a href="manageUsers.php" class="nav-link text-left"  class="dropdown-item" role="button" 
         ...
         <li style="width: 300px;font-size: 20px;" class="nav-item"> 
        <a href="servises.php" class="nav-link text-left active"  class="dropdown-item"  role="button" 
         aria-haspopup="true" aria-expanded="false">
         ...
         aria-haspopup="true" aria-expanded="false">
           ...
           <div class="container-fluid p-0 px-lg-0 px-md-0">
            ...
            <div  class="container-fluid px-lg-4">
              <h4 style="font-family:sans-serif;margin-top: 15px;color: #222e3c;" >Manage Services</h4>             
             <hr>   
             <?php if(isset($_GET['success'])){    ?>
              ...
              <i class="fas fa-user"></i>&nbsp;&nbsp;Add New Service</button> 
             ...
             <table class="table">
               <thead style="color: blue;" class="thead-dark">
                 <tr>
                   ...
                   <th scope="col">Service Administrator</th>
               ...
               <?php
                ...
                ?>
                 <tr>
                   ...
                   <td> 
                     <div class="col-lg-15">
                     <a href="editService.php?IdService=<?=$rows['IdService']?>" class="text-success" > <i class="fas fa-edit"></i> 
                     </a></td>
                     <td> <a href="#edit<?=$rows['IdService']?>" class="text-danger" data-toggle="modal" > <i class="fas fa-ban"></i> 
                     </a>
                     <div id="edit<?=$rows['IdService']?>" class="modal fade" role="dialog">
                                <form method="post" class="form-horizontal" role="form">
                                    <div class="modal-dialog modal-sm">
                                        <!-- Modal content-->
                                        <div class="modal-content">
                                            <div class="modal-header">                                  
                                                <h4 class="modal-title">Desactive Service</h4>
                                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                            </div>
                                            <div class="modal-body">
                          
                                            <h4 class="text-danger">are you sure want to desactivate this Service?</h4>                                                  
                                           </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-warning" data-dismiss="modal"><span class="glyphicon glyphicon-remove-circle"></span> Cancel</button>
                                               <a href="desactiveService.php?IdService=<?=$rows['IdService']?>" class="btn btn-primary"><span class="glyphicon glyphicon-edit"></span> Desactive</a> 
                                            </div>
                                        </div>
                                    </div>
                                </form>
                   ...
                   <!------------------------------------------------------------------------------------>
                   <td> <a href="#edit1<?=$rows['IdService']?>" class="text-success" data-toggle="modal" > <i class="fas fa-check"></i> 
                     </a>
                     <div id="edit1<?=$rows['IdService']?>" class="modal fade" role="dialog">
                                <form method="post" class="form-horizontal" role="form">
                                    <div class="modal-dialog modal-sm">
                                        <!-- Modal content-->
                                        <div class="modal-content">
                                            <div class="modal-header">                                  
                                                <h4 class="modal-title">active Service</h4>
                                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                            </div>
                                            <div class="modal-body">
                          
                                            <h4 class="text-danger">are you sure want to activate this Service?</h4>                                                  
                                           </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-warning" data-dismiss="modal"><span class="glyphicon glyphicon-remove-circle"></span> Cancel</button>
                                               <a href="activeService.php?IdService=<?=$rows['IdService']?>" class="btn btn-primary"><span class="glyphicon glyphicon-edit"></span> active</a> 
                                            </div>
                                        </div>
                                    </div>
                                </form>
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form action="createService.php" method="POST">
                    <h3 class="text-info text-center"><strong> Adding New Service </strong></h3>
                    <br>
                    ...
                    <div class="form-group">
                        <input type="text" id="names" name="names" value="<?php if(isset($_GET['names'])) echo ($_GET['names']) ; ?>" class="form-control form-control-lg" placeholder="service name">
                    </div><br>                   
                    <?php

                              include "db_connection.php";

                              $sql = "SELECT IdUtilisateur,NomUtilisateur FROM utilisateur where Role ='user'";
                              $result = mysqli_query($conn,$sql);
                              
                              echo "<select class='form-control form-control-lg' name='idut' id='idut'  >";
                     ...
                     <br>
                     <div class="modal-footer">
                  <button  class="btn btn-primary btn-lg btn-block" style="color: white;" name="create" @click="showAddModal=false">Add Service</button>
