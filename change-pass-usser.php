    ...
    if(isset($_POST['op']) && isset($_POST['np']) && isset($_POST['c_np'])){
        ...
        if(empty($op)){
            ...
            if(mysqli_num_rows($result) === 1){
                ...
                $sql_2 ="update utilisateur set Password='$np',ChangePwd='non' where IdUtilisateur='$id'";
                 mysqli_query($conn,$sql_2);
                 header("location:index.php?success=Your Password Has Been Changed Re-enter again");
